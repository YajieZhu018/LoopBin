...
for j,k in [('1','2'), ('3','4'), ('1','6'), ('2','6')]:
    ...
    for cond in ['control', 'degron']:
        ...
        bed_cluster_file = f'{il}{cond}_loops_control_{j}_degron_{k}.bed'
        # bed files of all loops
        bed_file = f'/usr/users/yzhu1/LoopBin/trials/saved_models/vade_7clusters_merged_control_degron_rep1/metaplot/temp/{cond}_loops.bed'
        # read in to lists
        ...
        bed_dict = {element:ind for ind, element in enumerate(bed)}
        # keep the indices from bed
        indices = [bed_dict[element] for element in bed_cluster if element in bed_dict]
